...
from app.api.v1.label.models.api.base_shipment_request import UpdateShipmentRequestModel
...
class UpdateShipmentRequest(BaseModel):
    ...
    shipment: UpdateShipmentRequestModel = Field(..., description="The shipment details, including the parcels and their contents.")