...
from app.api.v1.common.models.base_models import Dimensions, GeoLocation, MetaData, References, TrackingLevel, Weight
...
class TrackingData(BaseModel):
    ...
    shipment_events: Optional[list[TrackingEvent]] = Field(..., description="If tracking_level='shipment'. The tracking events that have been received are on the shipment-level, i.e. individual parcels in a multi-parcel are not individually trackable.")
    parcel_events: Optional[list[TrackingEventParcel]] = Field(..., description="If tracking_level='parcel'. The tracking events that have been received a for individual parcels in the shipment.")
...
class TrackingWebhookEvent(BaseModel):
    ...
    shipment_tracking_number: Optional[str] = Field(..., description="The tracking number of the shipment.")
